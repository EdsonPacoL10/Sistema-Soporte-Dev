                                ...
                                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_carpeta">
                                    ...
                                    <thead>
                                        ...
                                        <th class="w-10px pe-2">
                                            ...
                                            <th class="min-w-125px">tamaño</th>
        ...
        <div class="modal-content">
           ...
           <form id="uploadForm" enctype="multipart/form-data">
              <div class="mb-3">
                ...
                <div class="mb-3">
                    <label for="descripcion_archivo" class="form-label">Descripción del archivo:</label>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="formulario_edicion">
                    <!-- Aquí agrega los campos del formulario de edición -->
