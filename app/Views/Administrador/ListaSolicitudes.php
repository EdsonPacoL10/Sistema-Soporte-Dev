                    ...
                    <div class="topbar d-flex align-items-stretch flex-shrink-0" id="kt_topbar">
                        ...
                        <div class="d-flex align-items-center ms-2 ms-lg-3">
                            ...
                            <div id="kt_header_search"
                                class="header-search d-flex align-items-center topbar-search w-lg-225px"
                                ...
                                <div data-kt-search-element="content"
                                    ...
                                    <form data-kt-search-element="advanced-options-form" class="pt-1 d-none">
                                        ...
                                        <div class="d-flex justify-content-end">
                                            ...
                                            <a href="../../demo19/dist/pages/search/horizontal.html"
                        ...
                        <div class="d-flex align-items-center ms-2 ms-lg-3" id="kt_header_user_menu_toggle">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-semibold py-4 fs-6 w-275px"
                                ...
                                <div class="menu-item px-5">
                                    <a href="../../demo19/dist/account/overview.html" class="menu-link px-5">My
                                        Profile</a>
                                </div>
                                <!--end::Menu item-->
                                <!--begin::Menu item-->
                                ...
                                <div class="menu-item px-5" data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
                                    ...
                                    <div class="menu-sub menu-sub-dropdown w-175px py-4">
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                            <a href="../../demo19/dist/account/referrals.html"
                                                class="menu-link px-5">Referrals</a>
                                        </div>
                                        <!--end::Menu item-->
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                            <a href="../../demo19/dist/account/billing.html"
                                                class="menu-link px-5">Billing</a>
                                        </div>
                                        <!--end::Menu item-->
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                            <a href="../../demo19/dist/account/statements.html"
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-5">
                                    <a href="../../demo19/dist/account/statements.html" class="menu-link px-5">My
                                        Statements</a>
                                </div>
                                <!--end::Menu item-->
                                <!--begin::Menu separator-->
                                ...
                                <div class="menu-item px-5 my-1">
                                    <a href="../../demo19/dist/account/settings.html" class="menu-link px-5">Account
                                        Settings</a>
                                </div>
                                <!--end::Menu item-->
                                <!--begin::Menu item-->
                                    ...
                                    <div class="menu-state-bg menu-extended" data-kt-menu-dismiss="true">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8 mb-3 mb-lg-0 py-3 px-3 py-lg-6 px-lg-6">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6 mb-3">
                                                        ...
                                                        <div class="menu-item p-0 m-0">
                                                            <!--begin:Menu link-->
                                                            <a href="../../demo19/dist/dashboards/pos.html"
                                                                class="menu-link">
                                                                <span
                                                                    class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
                                            ...
                                            <div
                                                ...
                                                <div class="menu-item p-0 m-0">
                                                    <!--begin:Menu link-->
                                                    <a href="../../demo19/dist/dashboards/social.html"
                                                        class="menu-link py-2">
                                                ...
                                                <div class="menu-item p-0 m-0">
                                                    <!--begin:Menu link-->
                                                    <a href="../../demo19/dist/dashboards/delivery.html"
                                                        class="menu-link py-2">
                                                ...
                                                <div class="menu-item p-0 m-0">
                                                    <!--begin:Menu link-->
                                                    <a href="../../demo19/dist/dashboards/crypto.html"
                                                        class="menu-link py-2">
                                                ...
                                                <div class="menu-item p-0 m-0">
                                                    <!--begin:Menu link-->
                                                    <a href="../../demo19/dist/dashboards/school.html"
                                                        class="menu-link py-2">
                                                ...
                                                <div class="menu-item p-0 m-0">
                                                    <!--begin:Menu link-->
                                                    <a href="../../demo19/dist/dashboards/podcast.html"
                                                        class="menu-link py-2">
                                                    ...
                                                    <div class="col-lg-8">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-3 mb-6 mb-lg-0">
                                                                ...
                                                                <div class="menu-item p-0 m-0">
                                                                    <!--begin:Menu link-->
                                                                    <a href="../../demo19/dist/pages/user-profile/overview.html"
                                                                        class="menu-link">
                                                                ...
                                                                <div class="menu-item p-0 m-0">
                                                                    <!--begin:Menu link-->
                                                                    <a href="../../demo19/dist/pages/user-profile/projects.html"
                                                                        class="menu-link">
                                                                ...
                                                                <div class="menu-item p-0 m-0">
                                                                    <!--begin:Menu link-->
                                                                    <a href="../../demo19/dist/pages/user-profile/campaigns.html"
                                                                        class="menu-link">
                                                                ...
                                                                <div class="menu-item p-0 m-0">
                                                                    <!--begin:Menu link-->
                                                                    <a href="../../demo19/dist/pages/user-profile/documents.html"
                                                                        class="menu-link">
                                                                ...
                                                                <div class="menu-item p-0 m-0">
                                                                    <!--begin:Menu link-->
                                                                    <a href="../../demo19/dist/pages/user-profile/followers.html"
                                                                        class="menu-link">
                                                            ...
                                                            <div class="col-lg-3 mb-6 mb-lg-0">
                                                                ...
                                                                <div class="mb-6">
                                                                    ...
                                                                    <div class="menu-item p-0 m-0">
                                                                        <!--begin:Menu link-->
                                                                        <a href="../../demo19/dist/pages/about.html"
                                                                            class="menu-link">
                                                                    ...
                                                                    <div class="menu-item p-0 m-0">
                                                                        <!--begin:Menu link-->
                                                                        <a href="../../demo19/dist/pages/team.html"
                                                                            class="menu-link">
                                                                    ...
                                                                    <div class="menu-item p-0 m-0">
                                                                        <!--begin:Menu link-->
                                                                        <a href="../../demo19/dist/pages/contact.html"
                                                                            class="menu-link">
                                                                    ...
                                                                    <div class="menu-item p-0 m-0">
                                                                        <!--begin:Menu link-->
                                                                        <a href="../../demo19/dist/pages/licenses.html"
                                                                            class="menu-link">
                                                                    ...
                                                                    <div class="menu-item p-0 m-0">
                                                                        <!--begin:Menu link-->
                                                                        <a href="../../demo19/dist/pages/sitemap.html"
                                                                            class="menu-link">
                                                                ...
                                                                <div class="mb-0">
                                                                    ...
                                                                    <div class="menu-item p-0 m-0">
                                                                        <!--begin:Menu link-->
                                                                        <a href="../../demo19/dist/pages/careers/list.html"
                                                                            class="menu-link">
                                                                    ...
                                                                    <div class="menu-item p-0 m-0">
                                                                        <!--begin:Menu link-->
                                                                        <a href="../../demo19/dist/pages/careers/apply.html"
                                                                            class="menu-link">
                                                            ...
                                                            <div class="col-lg-3 mb-6 mb-lg-0">
                                                                ...
                                                                <div class="mb-6">
                                                                    ...
                                                                    <div class="menu-item p-0 m-0">
                                                                        <!--begin:Menu link-->
                                                                        <a href="../../demo19/dist/pages/faq/classic.html"
                                                                            class="menu-link">
                                                                    ...
                                                                    <div class="menu-item p-0 m-0">
                                                                        <!--begin:Menu link-->
                                                                        <a href="../../demo19/dist/pages/faq/extended.html"
                                                                            class="menu-link">
                                                                ...
                                                                <div class="mb-6">
                                                                    ...
                                                                    <div class="menu-item p-0 m-0">
                                                                        <!--begin:Menu link-->
                                                                        <a href="../../demo19/dist/pages/blog/home.html"
                                                                            class="menu-link">
                                                                    ...
                                                                    <div class="menu-item p-0 m-0">
                                                                        <!--begin:Menu link-->
                                                                        <a href="../../demo19/dist/pages/blog/post.html"
                                                                            class="menu-link">
                                                                ...
                                                                <div class="mb-0">
                                                                    ...
                                                                    <div class="menu-item p-0 m-0">
                                                                        <!--begin:Menu link-->
                                                                        <a href="../../demo19/dist/pages/pricing/column.html"
                                                                            class="menu-link">
                                                                    ...
                                                                    <div class="menu-item p-0 m-0">
                                                                        <!--begin:Menu link-->
                                                                        <a href="../../demo19/dist/pages/pricing/table.html"
                                                                            class="menu-link">
                                                            ...
                                                            <div class="col-lg-3 mb-6 mb-lg-0">
                                                                ...
                                                                <div class="mb-0">
                                                                    ...
                                                                    <div class="menu-item p-0 m-0">
                                                                        <!--begin:Menu link-->
                                                                        <a href="../../demo19/dist/pages/social/feeds.html"
                                                                            class="menu-link">
                                                                    ...
                                                                    <div class="menu-item p-0 m-0">
                                                                        <!--begin:Menu link-->
                                                                        <a href="../../demo19/dist/pages/social/activity.html"
                                                                            class="menu-link">
                                                                    ...
                                                                    <div class="menu-item p-0 m-0">
                                                                        <!--begin:Menu link-->
                                                                        <a href="../../demo19/dist/pages/social/followers.html"
                                                                            class="menu-link">
                                                                            <span class="menu-title">Followers</span>
                                                                        </a>
                                                                        <!--end:Menu link-->
                                                                    ...
                                                                    <div class="menu-item p-0 m-0">
                                                                        <!--begin:Menu link-->
                                                                        <a href="../../demo19/dist/pages/social/settings.html"
                                                                            class="menu-link">
                                                    ...
                                                    <div class="col-lg-5 mb-6 mb-lg-0">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6">
                                                                ...
                                                                <div class="menu-item p-0 m-0">
                                                                    <!--begin:Menu link-->
                                                                    <a href="../../demo19/dist/account/overview.html"
                                                                        class="menu-link">
                                                                        <span class="menu-title">Overview</span>
                                                                    </a>
                                                                    <!--end:Menu link-->
                                                                ...
                                                                <div class="menu-item p-0 m-0">
                                                                    <!--begin:Menu link-->
                                                                    <a href="../../demo19/dist/account/security.html"
                                                                        class="menu-link">
                                                                ...
                                                                <div class="menu-item p-0 m-0">
                                                                    <!--begin:Menu link-->
                                                                    <a href="../../demo19/dist/account/activity.html"
                                                                        class="menu-link">
                                                                        <span class="menu-title">Activity</span>
                                                                    </a>
                                                                    <!--end:Menu link-->
                                                            ...
                                                            <div class="col-lg-6">
                                                                ...
                                                                <div class="menu-item p-0 m-0">
                                                                    <!--begin:Menu link-->
                                                                    <a href="../../demo19/dist/account/api-keys.html"
                                                                        class="menu-link">
                                                                ...
                                                                <div class="menu-item p-0 m-0">
                                                                    <!--begin:Menu link-->
                                                                    <a href="../../demo19/dist/account/logs.html"
                                                                        class="menu-link">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-3 mb-6 mb-lg-0">
                                                        ...
                                                        <div class="mb-6">
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo19/dist/authentication/layouts/corporate/sign-in.html"
                                                                    class="menu-link">
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo19/dist/authentication/layouts/corporate/sign-up.html"
                                                                    class="menu-link">
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo19/dist/authentication/layouts/corporate/two-steps.html"
                                                                    class="menu-link">
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo19/dist/authentication/layouts/corporate/reset-password.html"
                                                                    class="menu-link">
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo19/dist/authentication/layouts/corporate/new-password.html"
                                                                    class="menu-link">
                                                        ...
                                                        <div class="mb-0">
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo19/dist/authentication/layouts/overlay/sign-in.html"
                                                                    class="menu-link">
                                                                    <span class="menu-title">Sign-in</span>
                                                                </a>
                                                                <!--end:Menu link-->
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo19/dist/authentication/layouts/overlay/sign-up.html"
                                                                    class="menu-link">
                                                                    <span class="menu-title">Sign-up</span>
                                                                </a>
                                                                <!--end:Menu link-->
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo19/dist/authentication/layouts/overlay/two-steps.html"
                                                                    class="menu-link">
                                                                    <span class="menu-title">Two-steps</span>
                                                                </a>
                                                                <!--end:Menu link-->
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo19/dist/authentication/layouts/overlay/reset-password.html"
                                                                    class="menu-link">
                                                                    <span class="menu-title">Reset Password</span>
                                                                </a>
                                                                <!--end:Menu link-->
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo19/dist/authentication/layouts/overlay/new-password.html"
                                                                    class="menu-link">
                                                                    <span class="menu-title">New Password</span>
                                                                </a>
                                                                <!--end:Menu link-->
                                                    ...
                                                    <div class="col-lg-3 mb-6 mb-lg-0">
                                                        ...
                                                        <div class="mb-6">
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo19/dist/authentication/layouts/creative/sign-in.html"
                                                                    class="menu-link">
                                                                    <span class="menu-title">Sign-in</span>
                                                                </a>
                                                                <!--end:Menu link-->
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo19/dist/authentication/layouts/creative/sign-up.html"
                                                                    class="menu-link">
                                                                    <span class="menu-title">Sign-up</span>
                                                                </a>
                                                                <!--end:Menu link-->
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo19/dist/authentication/layouts/creative/two-steps.html"
                                                                    class="menu-link">
                                                                    <span class="menu-title">Two-steps</span>
                                                                </a>
                                                                <!--end:Menu link-->
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo19/dist/authentication/layouts/creative/reset-password.html"
                                                                    class="menu-link">
                                                                    <span class="menu-title">Reset Password</span>
                                                                </a>
                                                                <!--end:Menu link-->
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo19/dist/authentication/layouts/creative/new-password.html"
                                                                    class="menu-link">
                                                                    <span class="menu-title">New Password</span>
                                                                </a>
                                                                <!--end:Menu link-->
                                                        ...
                                                        <div class="mb-6">
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo19/dist/authentication/layouts/fancy/sign-in.html"
                                                                    class="menu-link">
                                                                    <span class="menu-title">Sign-in</span>
                                                                </a>
                                                                <!--end:Menu link-->
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo19/dist/authentication/layouts/fancy/sign-up.html"
                                                                    class="menu-link">
                                                                    <span class="menu-title">Sign-up</span>
                                                                </a>
                                                                <!--end:Menu link-->
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo19/dist/authentication/layouts/fancy/two-steps.html"
                                                                    class="menu-link">
                                                                    <span class="menu-title">Two-steps</span>
                                                                </a>
                                                                <!--end:Menu link-->
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo19/dist/authentication/layouts/fancy/reset-password.html"
                                                                    class="menu-link">
                                                                    <span class="menu-title">Reset Password</span>
                                                                </a>
                                                                <!--end:Menu link-->
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo19/dist/authentication/layouts/fancy/new-password.html"
                                                                    class="menu-link">
                                                                    <span class="menu-title">New Password</span>
                                                                </a>
                                                                <!--end:Menu link-->
                                                    ...
                                                    <div class="col-lg-3 mb-6 mb-lg-0">
                                                        ...
                                                        <div class="mb-0">
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo19/dist/authentication/extended/multi-steps-sign-up.html"
                                                                    class="menu-link">
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo19/dist/authentication/extended/two-factor-auth.html"
                                                                    class="menu-link">
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo19/dist/authentication/general/welcome.html"
                                                                    class="menu-link">
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo19/dist/authentication/general/verify-email.html"
                                                                    class="menu-link">
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo19/dist/authentication/extended/coming-soon.html"
                                                                    class="menu-link">
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo19/dist/authentication/general/password-confirmation.html"
                                                                    class="menu-link">
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo19/dist/authentication/general/account-deactivated.html"
                                                                    class="menu-link">
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo19/dist/authentication/general/error-404.html"
                                                                    class="menu-link">
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo19/dist/authentication/general/error-500.html"
                                                                    class="menu-link">
                                                    ...
                                                    <div class="col-lg-3 mb-6 mb-lg-0">
                                                        ...
                                                        <div class="mb-0">
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo19/dist/authentication/email/verify-email.html"
                                                                    class="menu-link">
                                                                    <span class="menu-title">Verify Email</span>
                                                                </a>
                                                                <!--end:Menu link-->
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo19/dist/authentication/email/invitation.html"
                                                                    class="menu-link">
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo19/dist/authentication/email/reset-password.html"
                                                                    class="menu-link">
                                                                    <span class="menu-title">Reset Password</span>
                                                                </a>
                                                                <!--end:Menu link-->
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo19/dist/authentication/email/password-change.html"
                                                                    class="menu-link">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-4 mb-6 mb-lg-0">
                                                                ...
                                                                <div class="mb-0">
                                                                    ...
                                                                    <div class="menu-item p-0 m-0">
                                                                        <!--begin:Menu link-->
                                                                        <a href="../../demo19/dist/utilities/modals/general/invite-friends.html"
                                                                            class="menu-link">
                                                                    ...
                                                                    <div class="menu-item p-0 m-0">
                                                                        <!--begin:Menu link-->
                                                                        <a href="../../demo19/dist/utilities/modals/general/view-users.html"
                                                                            class="menu-link">
                                                                    ...
                                                                    <div class="menu-item p-0 m-0">
                                                                        <!--begin:Menu link-->
                                                                        <a href="../../demo19/dist/utilities/modals/general/select-users.html"
                                                                            class="menu-link">
                                                                    ...
                                                                    <div class="menu-item p-0 m-0">
                                                                        <!--begin:Menu link-->
                                                                        <a href="../../demo19/dist/utilities/modals/general/upgrade-plan.html"
                                                                            class="menu-link">
                                                                    ...
                                                                    <div class="menu-item p-0 m-0">
                                                                        <!--begin:Menu link-->
                                                                        <a href="../../demo19/dist/utilities/modals/general/share-earn.html"
                                                                            class="menu-link">
                                                                    ...
                                                                    <div class="menu-item p-0 m-0">
                                                                        <!--begin:Menu link-->
                                                                        <a href="../../demo19/dist/utilities/modals/forms/new-target.html"
                                                                            class="menu-link">
                                                                    ...
                                                                    <div class="menu-item p-0 m-0">
                                                                        <!--begin:Menu link-->
                                                                        <a href="../../demo19/dist/utilities/modals/forms/new-card.html"
                                                                            class="menu-link">
                                                                    ...
                                                                    <div class="menu-item p-0 m-0">
                                                                        <!--begin:Menu link-->
                                                                        <a href="../../demo19/dist/utilities/modals/forms/new-address.html"
                                                                            class="menu-link">
                                                                    ...
                                                                    <div class="menu-item p-0 m-0">
                                                                        <!--begin:Menu link-->
                                                                        <a href="../../demo19/dist/utilities/modals/forms/create-api-key.html"
                                                                            class="menu-link">
                                                                    ...
                                                                    <div class="menu-item p-0 m-0">
                                                                        <!--begin:Menu link-->
                                                                        <a href="../../demo19/dist/utilities/modals/forms/bidding.html"
                                                                            class="menu-link">
                                                            ...
                                                            <div class="col-lg-4 mb-6 mb-lg-0">
                                                                ...
                                                                <div class="mb-6">
                                                                    ...
                                                                    <div class="menu-item p-0 m-0">
                                                                        <!--begin:Menu link-->
                                                                        <a href="../../demo19/dist/utilities/modals/wizards/create-app.html"
                                                                            class="menu-link">
                                                                    ...
                                                                    <div class="menu-item p-0 m-0">
                                                                        <!--begin:Menu link-->
                                                                        <a href="../../demo19/dist/utilities/modals/wizards/create-campaign.html"
                                                                            class="menu-link">
                                                                    ...
                                                                    <div class="menu-item p-0 m-0">
                                                                        <!--begin:Menu link-->
                                                                        <a href="../../demo19/dist/utilities/modals/wizards/create-account.html"
                                                                            class="menu-link">
                                                                    ...
                                                                    <div class="menu-item p-0 m-0">
                                                                        <!--begin:Menu link-->
                                                                        <a href="../../demo19/dist/utilities/modals/wizards/create-project.html"
                                                                            class="menu-link">
                                                                            <span class="menu-title">Create
                                                                                Project</span>
                                                                        </a>
                                                                    ...
                                                                    <div class="menu-item p-0 m-0">
                                                                        <!--begin:Menu link-->
                                                                        <a href="../../demo19/dist/utilities/modals/wizards/top-up-wallet.html"
                                                                            class="menu-link">
                                                                    ...
                                                                    <div class="menu-item p-0 m-0">
                                                                        <!--begin:Menu link-->
                                                                        <a href="../../demo19/dist/utilities/modals/wizards/offer-a-deal.html"
                                                                            class="menu-link">
                                                                    ...
                                                                    <div class="menu-item p-0 m-0">
                                                                        <!--begin:Menu link-->
                                                                        <a href="../../demo19/dist/utilities/modals/wizards/two-factor-authentication.html"
                                                                            class="menu-link">
                                                                ...
                                                                <div class="mb-0">
                                                                    ...
                                                                    <div class="menu-item p-0 m-0">
                                                                        <!--begin:Menu link-->
                                                                        <a href="../../demo19/dist/utilities/search/horizontal.html"
                                                                            class="menu-link">
                                                                    ...
                                                                    <div class="menu-item p-0 m-0">
                                                                        <!--begin:Menu link-->
                                                                        <a href="../../demo19/dist/utilities/search/vertical.html"
                                                                            class="menu-link">
                                                                    ...
                                                                    <div class="menu-item p-0 m-0">
                                                                        <!--begin:Menu link-->
                                                                        <a href="../../demo19/dist/utilities/modals/search/users.html"
                                                                            class="menu-link">
                                                                    ...
                                                                    <div class="menu-item p-0 m-0">
                                                                        <!--begin:Menu link-->
                                                                        <a href="../../demo19/dist/utilities/modals/search/select-location.html"
                                                                            class="menu-link">
                                                            ...
                                                            <div class="col-lg-4 mb-6 mb-lg-0">
                                                                ...
                                                                <div class="mb-0">
                                                                    ...
                                                                    <div class="menu-item p-0 m-0">
                                                                        <!--begin:Menu link-->
                                                                        <a href="../../demo19/dist/utilities/wizards/horizontal.html"
                                                                            class="menu-link">
                                                                            <span class="menu-title">Horizontal</span>
                                                                        </a>
                                                                        <!--end:Menu link-->
                                                                    ...
                                                                    <div class="menu-item p-0 m-0">
                                                                        <!--begin:Menu link-->
                                                                        <a href="../../demo19/dist/utilities/wizards/vertical.html"
                                                                            class="menu-link">
                                                                            <span class="menu-title">Vertical</span>
                                                                        </a>
                                                                        <!--end:Menu link-->
                                                                    ...
                                                                    <div class="menu-item p-0 m-0">
                                                                        <!--begin:Menu link-->
                                                                        <a href="../../demo19/dist/utilities/wizards/two-factor-authentication.html"
                                                                            class="menu-link">
                                                                            <span class="menu-title">Two Factor
                                                                                Auth</span>
                                                                        </a>
                                                                    ...
                                                                    <div class="menu-item p-0 m-0">
                                                                        <!--begin:Menu link-->
                                                                        <a href="../../demo19/dist/utilities/wizards/create-app.html"
                                                                            class="menu-link">
                                                                            <span class="menu-title">Create App</span>
                                                                        </a>
                                                                        <!--end:Menu link-->
                                                                    ...
                                                                    <div class="menu-item p-0 m-0">
                                                                        <!--begin:Menu link-->
                                                                        <a href="../../demo19/dist/utilities/wizards/create-campaign.html"
                                                                            class="menu-link">
                                                                            <span class="menu-title">Create
                                                                                Campaign</span>
                                                                        </a>
                                                                    ...
                                                                    <div class="menu-item p-0 m-0">
                                                                        <!--begin:Menu link-->
                                                                        <a href="../../demo19/dist/utilities/wizards/create-account.html"
                                                                            class="menu-link">
                                                                            <span class="menu-title">Create
                                                                                Account</span>
                                                                        </a>
                                                                    ...
                                                                    <div class="menu-item p-0 m-0">
                                                                        <!--begin:Menu link-->
                                                                        <a href="../../demo19/dist/utilities/wizards/create-project.html"
                                                                            class="menu-link">
                                                                            <span class="menu-title">Create
                                                                                Project</span>
                                                                        </a>
                                                                    ...
                                                                    <div class="menu-item p-0 m-0">
                                                                        <!--begin:Menu link-->
                                                                        <a href="../../demo19/dist/utilities/wizards/offer-a-deal.html"
                                                                            class="menu-link">
                                                                            <span class="menu-title">Offer a Deal</span>
                                                                        </a>
                                                                        <!--end:Menu link-->
                                            ...
                                            <div class="tab-pane w-lg-500px" id="kt_app_header_menu_pages_widgets">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-4 mb-6 mb-lg-0">
                                                        ...
                                                        <div class="menu-item p-0 m-0">
                                                            <!--begin:Menu link-->
                                                            <a href="../../demo19/dist/widgets/lists.html"
                                                                class="menu-link">
                                                        ...
                                                        <div class="menu-item p-0 m-0">
                                                            <!--begin:Menu link-->
                                                            <a href="../../demo19/dist/widgets/statistics.html"
                                                                class="menu-link">
                                                        ...
                                                        <div class="menu-item p-0 m-0">
                                                            <!--begin:Menu link-->
                                                            <a href="../../demo19/dist/widgets/charts.html"
                                                                class="menu-link">
                                                        ...
                                                        <div class="menu-item p-0 m-0">
                                                            <!--begin:Menu link-->
                                                            <a href="../../demo19/dist/widgets/mixed.html"
                                                                class="menu-link">
                                                        ...
                                                        <div class="menu-item p-0 m-0">
                                                            <!--begin:Menu link-->
                                                            <a href="../../demo19/dist/widgets/tables.html"
                                                                class="menu-link">
                                                        ...
                                                        <div class="menu-item p-0 m-0">
                                                            <!--begin:Menu link-->
                                                            <a href="../../demo19/dist/widgets/feeds.html"
                                                                class="menu-link">
                                                                <span class="menu-title">Feeds</span>
                                                            </a>
                                                            <!--end:Menu link-->
            ...
            <div class="wrapper d-flex flex-column flex-row-fluid container-xxl" id="kt_wrapper">
                ...
                <div class="toolbar d-flex flex-stack flex-wrap py-4 gap-2" id="kt_toolbar">
                    ...
                    <div class="d-flex align-items-center py-1">
                        <!--begin::Daterange-->
                        <a href="#" class="btn btn-sm btn-flex btn-light px-5 me-2" id="kt_dashboard_daterangepicker"
                            ...
                            <span class="me-2">
                                ...
                                <span class="text-info fw-bold" id="kt_dashboard_daterangepicker_date">Jul 5</span>
                            </span>
                            <!--begin::Svg Icon | path: icons/duotune/arrows/arr072.svg-->
                        ...
                        <div class="me-2">
                            <!--begin::Menu-->
                            <a href="#" class="btn btn-sm btn-flex btn-light" data-kt-menu-trigger="click"
                                data-kt-menu-placement="bottom-end">
                                    ...
                                    <div class="mb-10">
                                        ...
                                        <div>
                                            <select class="form-select form-select-solid" data-kt-select2="true"
                                                ...
                                                data-dropdown-parent="#kt_menu_62c3f36a0dd1f" data-allow-clear="true">
                                                <option></option>
                ...
                <div class="footer py-4 d-flex flex-column flex-md-row align-items-center justify-content-between"
                    ...
                    <div class="order-2 order-md-1">
                        <span class="text-white opacity-75 fw-semibold me-1">2022©</span>
    ...
    <div id="kt_activities" class="bg-body" data-kt-drawer="true" data-kt-drawer-name="activities"
        ...
        <div class="card shadow-none border-0 rounded-0">
                            ...
                            <div class="timeline-content mb-10 mt-n1">
                                ...
                                <div class="overflow-auto pb-5">
                                    ...
                                    <div
                                        ...
                                        <!--begin::Title-->
                                        <a href="../../demo19/dist/apps/projects/project.html"
                            ...
                            <div class="timeline-content mb-10 mt-n1">
                                ...
                                <div class="overflow-auto pb-5">
                                    <div
                                        ...
                                        <div class="d-flex flex-aligns-center pe-10 pe-lg-20">
                                            <!--begin::Icon-->
                                            <img alt="../../demo19/dist/apps/projects/project.html" class="w-30px me-3"
            ...
            <div class="card-footer py-5 text-center" id="kt_activities_footer">
                <a href="../../demo19/dist/pages/user-profile/activity.html" class="btn btn-bg-body text-primary">View
                    All Activities
                    <!--begin::Svg Icon | path: icons/duotune/arrows/arr064.svg-->
                ...
                <div id="kt_help_scroll" class="hover-scroll-overlay-y" data-kt-scroll="true"
                    ...
                    <div class="d-flex align-items-center mb-7">
                        ...
                        <div class="d-flex flex-stack flex-grow-1 ms-4 ms-lg-6">
                            ...
                            <div class="d-flex flex-column me-2 me-lg-5">
                                <!--begin::Title-->
                                <a href="../../demo19/dist/documentation/getting-started.html"
                    ...
                    <div class="d-flex align-items-center mb-7">
                        ...
                        <div class="d-flex flex-stack flex-grow-1 ms-4 ms-lg-6">
                            ...
                            <div class="d-flex flex-column me-2 me-lg-5">
                                <!--begin::Title-->
                                <a href="../../demo19/dist/documentation/base/utilities.html"
                    ...
                    <div class="d-flex align-items-center mb-7">
                        ...
                        <div class="d-flex flex-stack flex-grow-1 ms-4 ms-lg-6">
                            ...
                            <div class="d-flex flex-column me-2 me-lg-5">
                                <!--begin::Title-->
                                <a href="https://preview.keenthemes.com/metronic8/demo19/layout-builder.html"
                    ...
                    <div class="d-flex align-items-center mb-7">
                        ...
                        <div class="d-flex flex-stack flex-grow-1 ms-4 ms-lg-6">
                            ...
                            <div class="d-flex flex-column me-2 me-lg-5">
                                <!--begin::Title-->
                                <a href="../../demo19/dist/documentation/getting-started/changelog.html"
                                    ...
                                    <div class="w-100">
                                        ...
                                        <div class="fv-row mb-10">
                                            ...
                                            <label class="d-flex align-items-center fs-5 fw-semibold mb-2">
                                                ...
                                                <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip"
                                                    title="Codigo del funcionario"></i>
                                            </label>
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="text" class="form-control form-control-lg form-control-solid"
                                                name="codigo" id="codigo" placeholder="Ingrese codigo" />
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Input group-->
                                        <!--begin::Input group-->
                                        ...
                                        <div class="fv-row mb-10">
                                            ...
                                            <!--begin::Input-->
                                            <input type="text" class="form-control form-control-lg form-control-solid"
                                                name="entidad" id="entidad" placeholder="Entidad de donde pertenece" />
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Input group-->
                                        <!--begin::Input group-->
                                        <div class="fv-row mb-10">
                                            ...
                                            <!--begin::Input-->
                                            <input type="text" class="form-control form-control-lg form-control-solid"
                                                name="oficina" id="oficina" placeholder="Ingresar oficina" />
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Input group-->
                                        <!--begin::Input group-->
                                        <div class="fv-row mb-10">
                                            ...
                                            <input type="text" class="form-control form-control-lg form-control-solid"
                                                ...
                                                placeholder="Ingresar dependencia donde pertenece" />
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Input group-->
                                    </div>
                                    ...
                                    <div class="w-100">
                                        ...
                                        <div class="fv-row">
                                            ...
                                            <label class="d-flex flex-stack cursor-pointer mb-5">
                                                ...
                                                <select class="form-select" name="telefonia" id="telefonia">
                                            ...
                                            <label class="d-flex flex-stack cursor-pointer mb-5">
                                                ...
                                                <select class="form-select" id="otros" name="otros"> required
                                                    <option value="1" selected>Seleccione</option>
                                                    <option value="2">Opción 2</option>
                                                    <option value="3">Opción 3</option>
                                                </select>
