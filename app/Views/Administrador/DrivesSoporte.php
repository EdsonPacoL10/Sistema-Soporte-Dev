...
<html lang="es">
    ...
    <body data-kt-name="metronic" id="kt_body" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled">
                            ...
                            <div class="menu menu-column menu-lg-row menu-rounded menu-active-bg menu-title-gray-800 menu-state-primary menu-arrow-gray-500 fw-semibold my-5 my-lg-0 align-items-stretch flex-grow-1 px-2 px-lg-0" id="kt_header_menu" data-kt-menu="true">
                                ...
                                <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" class="  menu-item here show menu-lg-down-accordion menu-here-bg me-0 me-lg-2">
                                    ...
                                    <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown px-lg-2 py-lg-4 w-lg-200px">
                                        ...
                                        <div class="menu-item">
                                            <!--begin:Menu link-->
                                            <a class="menu-link py-3" href="/drives" title="Check out over 200 in-house components, plugins and ready for use solutions" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                                                <span class="menu-icon">
                ...
                <div class="wrapper d-flex flex-column flex-row-fluid container-xxl" id="kt_wrapper">
                    ...
                    <div class="toolbar d-flex flex-stack flex-wrap py-4 gap-2" id="kt_toolbar">
                        ...
                        <div class="page-title d-flex flex-column align-items-start me-3 gap-1">
                            ...
                            <!--end::Separator-->
                            <!--begin::Description-->
                            <small class="text-gray-500 fs-7 fw-semibold my-1">Galeria Soporte</small>
                            <!--end::Description-->
                            <!--begin::Separator-->
                            <span class="h-20px border-gray-400 border-start mx-3"></span>
                            <!--end::Separator-->
                            <!--begin::Description-->
                            <small class="text-gray-500 fs-7 fw-semibold my-1">Drivers</small>
                            <!--end::Description--></h1>
                            <!--end::Title-->
                        </div>
                        <!--end::Page title-->
                    ...
                    <div class="d-flex flex-row flex-column-fluid align-items-stretch">
                        ...
                        <div class="content flex-row-fluid" id="kt_content">
                            ...
                            <div class="card">
                            <!--begin::Card header-->
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modal_nueva_carpeta">
                                <!-- Icono -->
                                <span class="svg-icon svg-icon-2">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_carpeta">
                                    ...
                                    <thead>
                                        ...
                                        <th class="w-10px pe-2">
                                            ...
                                            <th class="min-w-125px">Cantidad de archivo</th>
        ...
        <div class="modal fade" id="modal_nueva_carpeta" tabindex="-1" aria-labelledby="modal_nueva_carpeta_label" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <!-- Cabecera del modal -->
            <div class="modal-header">
                <h5 class="modal-title" id="modal_nueva_carpeta_label">Crear Nuevo Archivo</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <!-- Cuerpo del modal -->
            <div class="modal-body">
                <!-- Aquí puedes agregar el contenido del formulario para crear el archivo -->
                <!-- Por ejemplo: -->
                    ...
                    <div class="mb-3">
                        <label for="nombre_archivo" class="form-label">Descripcion de la carpeta:</label>
                        <input type="text" class="form-control" id="descripcion_archivo" name="descripcion_archivo" >
                    </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" id="cerrar" name="cerrar" data-bs-dismiss="modal">Cerrar</button>
                  <button type="button" class="btn btn-primary" id="guardarArchivo">Guardar</button>
                 </div>
        </div>
    </div>
</div>
...
/*********************************************************************************************
 *tabla de carpetas ver carpetas
 ******************************************************************************************/
$(document).ready(function () {
        ...
        dt = $('#kt_table_carpeta').DataTable({
            ...
            columnDefs: [
               ...
               
                {
                    ...
                    render: function (data) {
                        return `
                        <form action="/listaArchivos" method="post" style="display: inline;">
                        <input type="hidden" name="nombre" value="${data}">
...
$('#guardarArchivo').click(function () {
            ...
            var otherData = {
                ...
                descripcion_archivo: document.getElementById("descripcion_archivo").value,
            };
            ...
            // Enviar los datos mediante una solicitud AJAX
            var xhr = new XMLHttpRequest();
            xhr.open("POST", "/enviarCarpeta", true);
            xhr.setRequestHeader("Content-Type", "application/json;charset=UTF-8");
            xhr.onreadystatechange = function () {
                if (xhr.readyState === 4 && xhr.status === 200) {
                    // Manejar la respuesta del servidor si es necesario
 ...
 /********************************************************************************
* proceso de validacion de campos para el envio
********************************************************************************* */	
const guardarBtn = document.getElementById('guardarArchivo');
const nombreArchivoInput = document.getElementById('nombre_archivo');
const descripcionArchivoInput = document.getElementById('descripcion_archivo');
const modalCerrarBtn = document.querySelector('[data-bs-dismiss="modal"]');

// Función para verificar si todos los campos están llenos
function verificarCamposLlenos() {
    const nombreArchivo = nombreArchivoInput.value.trim();
    const descripcionArchivo = descripcionArchivoInput.value.trim();
    return nombreArchivo && descripcionArchivo;
}

// Función para mostrar la alerta cuando el cursor se acerca al botón
function mostrarAlertaSiCamposNoEstanLlenos() {
...
// Agregar event listener al botón "Guardar" para mostrar la alerta en mouseover
guardarBtn.addEventListener('mouseover', mostrarAlertaSiCamposNoEstanLlenos);

// Agregar event listener al botón "Guardar" para el clic
guardarBtn.addEventListener('click', () => {
    ...
    if (!nombreArchivo || !descripcionArchivo) {
        ...
        return; // Detiene la operación si falta algún campo
    }

    // Simula una operación en la base de datos (esto debería reemplazarse con tu lógica real)
    const operacionExitosa = true; // Cambia esto según el resultado de tu operación
    ...
    if (operacionExitosa) {
        ...
        descripcionArchivoInput.value = '';
    } else {
        Swal.fire({
            icon: 'error',
            title: '¡Error!',
            text: 'No se pudo guardar el archivo. Por favor, inténtalo de nuevo.',
        });
    }
});

// Agregar event listener al botón "Cerrar" del modal
...
// Verificar inicialmente el estado de los campos
