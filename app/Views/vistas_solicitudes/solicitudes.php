...
<body data-kt-name="metronic" id="kt_body" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled">
                    ...
                    <div class="header-menu container-xxl flex-column align-items-stretch flex-lg-row"
                        ...
                        <div class="menu menu-column menu-lg-row menu-rounded menu-active-bg menu-title-gray-800 menu-state-primary menu-arrow-gray-500 fw-semibold my-5 my-lg-0 align-items-stretch flex-grow-1 px-2 px-lg-0"
                                ...
                                <div
                                        ...
                                        <div
                                            ...
                                            <div class="menu-item">
                                                ...
                                                <a class="menu-link py-3"
                                                    ...
                                                    <span class="menu-title">Nuevos Proyectos</span>
                                                </a>
                                                <!--end:Menu link-->
                                            </div>
                                            <!--end:Menu item-->
                                            ...
                                            <div class="menu-item">
                                                ...
                                                <a class="menu-link py-3"
                                                    ...
                                                    <span class="menu-title">Mejorar Proyectos</span>
                                                </a>
                                                <!--end:Menu link-->
                                            </div>
                                            <!--end:Menu item-->
                                        ...
                                        <div
                                            ...
                                            <div class="menu-item">
                                                ...
                                                <a class="menu-link py-3"
                                                    ...
                                                    <span class="menu-title">Area Sistemas</span>
                                                </a>
                                                <!--end:Menu link-->
                                            </div>
                                            <!--end:Menu item-->
                                    ...
                                    <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                        ...
                                        <div
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link py-3" href="Solicitudes">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div class="menu-item">
                                                ...
                                                <a class="menu-link py-3"
                                                    ...
                                                    <span class="menu-title">Ver &amp; Responder</span>
                                                </a>
                                                <!--end:Menu link-->
                                            </div>
                                            <!--end:Menu item-->
                            ...
                            <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
                                ...
                                <!--begin:Menu link-->
                                <span class="menu-link py-3">
                                    <span class="menu-title">Subir Ayuda</span>
                                    <span class="menu-arrow d-lg-none"></span>
                                </span>
                                <!--end:Menu link-->
                                <!--begin:Menu sub-->
            ...
            <div class="wrapper d-flex flex-column flex-row-fluid container-xxl" id="kt_wrapper">
                ...
                <div class="toolbar d-flex flex-stack flex-wrap py-4 gap-2" id="kt_toolbar">
                    ...
                    <div class="page-title d-flex flex-column align-items-start me-3 gap-1">
                        <!--begin::Title-->
                        <h1 class="d-flex text-dark fw-bold m-0 fs-3">Tareas
                            <!--begin::Separator-->
                            <span class="h-20px border-gray-400 border-start mx-3"></span>
                            <!--end::Separator-->
                            <!--begin::Description-->
                            <small class="text-gray-500 fs-7 fw-semibold my-1">Soporte</small>
                            <!--begin::Separator-->
                            <span class="h-20px border-gray-400 border-start mx-3"></span>
                            <!--end::Separator-->
                            <!--begin::Description-->
                            <small class="text-gray-500 fs-7 fw-semibold my-1">Solicitudes</small>
                            <!--end::Description-->
                        </h1>
                        <!--end::Title-->
                    </div>
                                    ...
                                    <div class="mb-10">
                                        ...
                                        <div>
                                            <select class="form-select form-select-solid" data-kt-select2="true"
                                                ...
                                                data-dropdown-parent="#kt_menu_62c3f3bfb56d8" data-allow-clear="true">
                                                <option></option>
                    ...
                    <div class="content flex-row-fluid" id="kt_content">
                        ...
                        <div class="card">
                            ...
                            <div class="card-header">
                                ...
                                <div class="card-toolbar">
                                    <a href="../../demo19/dist/apps/calendar.html" class="btn btn-primary">Manage
                                        Calendar</a>
                                </div>
                            </div>
                            <!--end::Card header-->
    ...
    <script src="assets/js/custom/documentation/base/modal.js"></script>
