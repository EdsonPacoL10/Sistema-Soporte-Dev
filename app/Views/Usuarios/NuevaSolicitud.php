                                    ...
                                    <div class="w-100">
                                        ...
                                        <div class="fv-row mb-10">
                                            ...
                                            <input type="text" class="form-control form-control-lg form-control-solid"
                                                name="codigo" id="codigo" placeholder="Ingrese codigo"  value="<?php echo $datos[0]->id ?> "disabled />
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Input group-->
                                        <!--begin::Input group-->
                                        <div class="fv-row mb-10">
                                            ...
                                            <input type="text" class="form-control form-control-lg form-control-solid"
                                                ...
                                                placeholder="Nombre de funcionario"  oninput="validarSoloLetras(this)" />
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Input group-->
                                        <!--begin::Input group-->
                                        ...
                                        <div class="fv-row mb-10">
                                            ...
                                            <!--begin::Input-->
                                            <input type="text" class="form-control form-control-lg form-control-solid"
                                                name="oficina" id="oficina" placeholder="Ingresar oficina"  oninput="validarLetrasYNumeros(this)"/>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Input group-->
                                        <!--begin::Input group-->
                                        <div class="fv-row mb-10">
                                            ...
                                            <input type="text" class="form-control form-control-lg form-control-solid"
                                                ...
                                                placeholder="Ingresar dependencia donde pertenece" oninput="validarSoloLetras(this)"/>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Input group-->
                                    </div>
                                    ...
                                    <div class="w-100">
                                        ...
                                        <div class="d-flex flex-stack">
                                            ...
                                            <label class="form-check form-switch form-check-custom form-check-solid">
                                                <input class="form-check-input" type="checkbox" value="0"  id="miCheckbox" onchange="mostrarAlerta()" />
...
function validarSoloLetras(input) {
    ...
    function mostrarAlerta() {
        ...
        if (checkbox.checked) {
            // El checkbox está marcado (valor 1)
