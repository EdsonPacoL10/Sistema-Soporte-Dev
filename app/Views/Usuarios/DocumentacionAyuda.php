        ...
        <div class="page d-flex flex-column flex-column-fluid">
                    ...
                    <div class="topbar d-flex align-items-stretch flex-shrink-0" id="kt_topbar">
                        ...
                        <div class="d-flex align-items-center ms-2 ms-lg-3" id="kt_header_user_menu_toggle">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-semibold py-4 fs-6 w-275px"
                                ...
                                <div class="menu-item px-3">
                                    <div class="menu-content d-flex align-items-center px-3">
                                        ...
                                        <div class="d-flex flex-column">
                                            ...
                                            <a href="#" class="fw-semibold text-muted text-hover-primary fs-7"><?= session()->get('type') ?></a>
                                        </div>
                                        <!--end::Username-->
                                    </div>
                                </div>
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-5">
                                    <a href="<?php echo base_url('/salir') ?>" class="menu-link px-5">Cerrar Sesion</a>
                                </div>
                                <!--end::Menu item-->
                            </div>
                                ...
                                <div
                                    ...
                                    <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                        ...
                                        <div
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link py-3" href="/NuevaSolicitud">
            ...
            <div class="wrapper d-flex flex-column flex-row-fluid container-xxl" id="kt_wrapper">
                    ...
                    <div class="page-title d-flex flex-column align-items-start me-3 gap-1">
                        ...
                        <ul class="breadcrumb breadcrumb-dot fw-semibold text-gray-600 fs-7">
                            ...
                            <li class="breadcrumb-item text-gray-600">
                                <a href="AyudaUsuario" class="text-gray-600 text-hover-primary">Ayuda</a>
                            </li>
                            <!--end::Item-->
                            <!--begin::Item-->
                            <li class="breadcrumb-item text-gray-600">Documentacion</li>
                            <!--end::Item-->
                ...
                <!--end::Toolbar-->
                    ...
                    <div class="content flex-row-fluid" id="kt_content">
                        ...
                        <br>
                        <h2>Lista de documentos de ayuda</h2>
            ...
            <div class="footer py-4 d-flex flex-column flex-md-row align-items-center justify-content-between"
                ...
                <div class="order-2 order-md-1">
                    <p>&copy; 2022 Ministerio de Desarrollo Productivo y Economía Plural (MPDyEP) - Todos los derechos
                        reservados.</p>
                ...
                <ul class="menu menu-white menu-hover-primary fw-semibold order-1 opacity-75">
                    ...
                    <p><a href="https://produccion.gob.bo/" target="_blank"
                            style="text-decoration: none; color: #3498db; font-weight: bold; font-size: 18px;"><i
                                class="fas fa-globe" style="color: black; font-size: 24px;"></i> MPDyEP</a></p>
